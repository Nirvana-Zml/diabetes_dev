...
public class ConsultationV2Controller {

    private final ConsultationService consultationService;

    public ConsultationV2Controller(ConsultationService consultationService) {
    ...
    @GetMapping("/ai-doctors/departments")
    public ApiResponse<List<String>> listDepartments() {
        return ApiResponse.ok(consultationService.listDepartments());
    }
