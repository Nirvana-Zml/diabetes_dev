...
| audit-service | 8088 | DIABETES_AUDIT | 审计日志 | `/admin/audit/*` |
...
docker compose up -d --build gateway user-service home-service health-service checkin-service consultation-service plan-service article-service audit-service
```
